...
public class TelaAdcMedico extends JFrame {
	...
	public TelaAdcMedico() {
		...
		txtXxxxxxxxxxx.setBounds(563, 358, 206, 33);
		contentPane.add(txtXxxxxxxxxxx);
		
		txtXxxxx = new JTextField();
		txtXxxxx.setText("x.xxxx");
		txtXxxxx.setColumns(10);
		txtXxxxx.setBounds(563, 418, 206, 33);
		contentPane.add(txtXxxxx);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String cpf = txtXxxxxxxxxxx.getText(); 
				String crm = txtXxxxx.getText();
